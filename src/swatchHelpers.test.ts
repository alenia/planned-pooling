...
describe('rowsTillMirrored', () => {
  ...
  describe('for an ABAB color sequence', () => {
    ...
    describe('when the color sequence lengths are 2, 5, 2, 6', () => {
      const colorSequence = [
        {color: '#00f', length: 2},
        {color: '#fff', length: 5},
        {color: '#00f', length: 2},
    ...
    describe("when the first color and second color are closer in length", () => {
      const colorSequence = [
        {color: '#00f', length: 5},
        {color: '#fff', length: 6},
        {color: '#00f', length: 5},
    ...
    describe("when the first color is the same length as the alternating color", () => {
      const colorSequence = [
        {color: '#00f', length: 6},
        {color: '#fff', length: 6},
        {color: '#00f', length: 6},
    ...
    describe("when the first color is longer than the alternating color", () => {
      const colorSequence = [
        {color: '#00f', length: 6},
        {color: '#fff', length: 3},
        {color: '#00f', length: 6},
  ...
  it.skip("returns the number of rows until the position of the colors in the first two rows matches up with what happens in the last two rows but mirrored when alternating row lengths", () => {
    ...
    12  o.....
     */
    expect(rowsTillMirrored({numberOfRows: 3, colorSequence, stitchesPerRow: 6, colorShift: 0, staggerLengths: true, staggerType: StaggerType.normal})).toEqual(12)
    /*
     1 oo.....o odd
     2  o.....o
     3 o.....oo odd
     */
    expect(rowsTillMirrored({numberOfRows: 3, colorSequence, stitchesPerRow: 7, colorShift: 0, staggerLengths: true, staggerType: StaggerType.normal})).toEqual(3)//maybe 2
  })
